--[[ Script that generates player's appropriate health points. If the player owns a
VIP or MEGA VIP pass, then the player's health goes up by 25% (VIP) or 50% (MEGA VIP).
If the player owns an Immortal God Long Sword and equips it, then the player gets
